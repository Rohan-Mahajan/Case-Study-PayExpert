...
class PayrollManagementSystem:
    ...
    def get_employee_details_for_update(self):
        ...
        # Return employee data as a tuple (like employee_data in add_employee)
        return (employee_id, 
                first_name, 
                last_name, 
                dob, gender, 
...
#             self.financial_service = FinancialRecordService()
#             print("Service instances initialized successfully.")
#         except DatabaseConnectionException as e:
#             print(f"Error: {str(e)}")
#             raise
...
#         try:
#             employee_data = self.get_employee_details()
#             if self.employee_service.add_employee(employee_data):
#                 print("Employee added successfully.")
#             else:
#                 print("Failed to add employee.")
#         except InvalidInputException as e:
...
#     def get_all_employees(self):
#         # Gets details of all the employes
#         try:
...
#         try:
#             employee_data = self.get_employee_details_for_update()  # Collect employee details using helper function
#             if self.employee_service.update_employee(employee_data):
#                 print("Employee updated successfully.")
#             else:
#                 print("Failed to update employee.")
#         except EmployeeNotFoundException as e:
...
#         try:
#             employee_id = input("Enter Employee ID to remove: ")
#             if self.employee_service.remove_employee(employee_id):
#                 print("Employee removed successfully.")
#             else:
#                 print("Failed to remove employee.")
#         except EmployeeNotFoundException as e:
...
#         try:
#             payroll_id = int(input("Enter Payroll Id: "))
#             PayrollService.get_payroll_by_id(payroll_id)
#         except PayrollGenerationException as e:
#             print(f"Error: {str(e)}")
#         except Exception as e:
#             print(f"Error: {str(e)}")
...
#         try:
#             payroll_data = self.get_payroll_details()  # Collect payroll details using helper function
#             if self.payroll_service.generate_payroll(payroll_data):
#                 print("Payroll generated successfully.")
#             else:
#                 print("Failed to generate payroll.")
#         except PayrollGenerationException as e:
...
#     def get_payroll_for_employee(self):
#             # Handles getting payroll for perticular employee
#             try:
#                 employee_id = int(input("Enter employee ID: "))
#                 PayrollService.get_payrolls_for_employee(employee_id)
#             except InvalidInputException as e:
#                 print(f"Invalid input: {str(e)}")
#             except Exception as e:
#                 print(f"Error: {str(e)}")
...
#             start_date = input("Enter start date (YYYY-MM-DD): ")
#             end_date = input("Enter end date (YYYY-MM-DD): ")
#             PayrollService.get_payrolls_for_period(start_date, end_date)
#         except PayrollGenerationException as e:
#              print(f"Error: {str(e)}")
#         except Exception as e:
#             print(f"Error: {str(e)}")
...
#             employee_id = input("Enter Employee ID: ")
#             tax_year = input("Enter Tax Year: ")
#             if self.tax_service.calculate_tax(employee_id, tax_year):
#                 print("Tax calculated successfully.")
#             else:
#                 print("Failed to calculate tax.")
#         except TaxCalculationException as e:
...
#         try:
#             tax_id = int(input("Enter Tax ID: "))
#             TaxService.get_tax_by_id(tax_id)
#         except InvalidInputException as e:
#                 print(f"Invalid input: {str(e)}")
#         except Exception as e:
#                 print(f"Error: {str(e)}")
...
#         try:
#             employee_id = int(input("Enter Employee ID: "))
#             TaxService.get_taxes_for_employee(employee_id)
#         except InvalidInputException as e:
#                 print(f"Invalid input: {str(e)}")
#         except Exception as e:
#                 print(f"Error: {str(e)}")
...
#         try:
#             tax_year = int(input("Enter Tax Year: "))
#             TaxService.get_taxes_for_year(tax_year)
#         except InvalidInputException as e:
#                 print(f"Invalid input: {str(e)}")
#         except Exception as e:
#                 print(f"Error: {str(e)}")
...
#         try:
#             record_id = int(input("Enter Record ID: "))
#             FinancialRecordService.get_financial_record_by_id(record_id)
#         except FinancialRecordException as e:
#                 print(f"Error: {str(e)}")
#         except InvalidInputException as e:
#                 print(f"Invalid input: {str(e)}")
...
#         try:
#             financial_data = self.get_financial_record_details()  # Collect financial record details
#             if self.financial_service.add_financial_record(financial_data):
#                 print("Financial record added successfully.")
#             else:
#                 print("Failed to add financial record.")
#         except FinancialRecordException as e:
...
#         try:
#             employee_id = int(input("Enter Employee Id: "))
#             FinancialRecordService.get_financial_records_for_employee(employee_id)
#         except FinancialRecordException as e:
#             print(f"Error: {str(e)}")
#         except InvalidInputException as e:
#             print(f"Invalid input: {str(e)}")
...
#         try:
#             record_date = input("Enter Date of Record: ")
#             FinancialRecordService.get_financial_records_for_date(record_date)
#         except FinancialRecordException as e:
#             print(f"Error: {str(e)}")
#         except InvalidInputException as e:
#             print(f"Invalid input: {str(e)}")
